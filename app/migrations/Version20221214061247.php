 ...
 */
final class Version20221214061247 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE followers (user_source UUID NOT NULL, user_target UUID NOT NULL, PRIMARY KEY(user_source, user_target))');
        ...
        $this->addSql('COMMENT ON COLUMN followers.user_source IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN followers.user_target IS \'(DC2Type:ulid)\'');
