 ...
 */
final class Version20221209184625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE micro_post_user (micro_post_id UUID NOT NULL, user_id UUID NOT NULL, PRIMARY KEY(micro_post_id, user_id))');
        ...
        $this->addSql('COMMENT ON COLUMN micro_post_user.micro_post_id IS \'(DC2Type:ulid)\'');
        $this->addSql('COMMENT ON COLUMN micro_post_user.user_id IS \'(DC2Type:ulid)\'');
